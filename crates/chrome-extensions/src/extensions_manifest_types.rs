...
extern "C" {
    #[wasm_bindgen(
        js_name = "extensionsManifestTypes.automation",
        typescript_type = "extensionsManifestTypes.automation"
    )]
    ...
    pub type automation;
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "extensionsManifestTypes.ContentCapabilities" , typescript_type = "extensionsManifestTypes.ContentCapabilities")]
    ...
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "extensionsManifestTypes.ExternallyConnectable" , typescript_type = "extensionsManifestTypes.ExternallyConnectable")]
    #[derive(Debug, Clone, PartialEq, Eq)]
    #[doc = ""]
    ...
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "extensionsManifestTypes.OptionsUI" , typescript_type = "extensionsManifestTypes.OptionsUI")]
    #[derive(Debug, Clone, PartialEq, Eq)]
    ...
    #[wasm_bindgen(
        js_name = "extensionsManifestTypes.SocketHostPatterns",
        typescript_type = "extensionsManifestTypes.SocketHostPatterns"
    )]
    #[derive(Debug, Clone, PartialEq)]
    #[doc = "<p>A single string or a list of strings representing host:port patterns.</p>"]
    pub type SocketHostPatterns;
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "extensionsManifestTypes.sockets" , typescript_type = "extensionsManifestTypes.sockets")]
    #[derive(Debug, Clone, PartialEq, Eq)]
    ...
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "extensionsManifestTypes.bluetooth" , typescript_type = "extensionsManifestTypes.bluetooth")]
    #[derive(Debug, Clone, PartialEq, Eq)]
    ...
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "extensionsManifestTypes.UsbPrinters" , typescript_type = "extensionsManifestTypes.UsbPrinters")]
    #[derive(Debug, Clone, PartialEq, Eq)]
    ...
    # [wasm_bindgen (extends = :: js_sys :: Array , js_name = "extensionsManifestTypes.KioskSecondaryApps" , typescript_type = "extensionsManifestTypes.KioskSecondaryApps")]
    #[derive(Debug, Clone, PartialEq, Eq)]
