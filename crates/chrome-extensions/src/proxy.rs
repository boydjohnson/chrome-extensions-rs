...
extern "C" {
    ...
    pub fn fallbackProxy(this: &ProxyRules) -> Option<ProxyServer>;
    # [wasm_bindgen (method , getter , js_class = ProxyRules)]
    #[doc = "The proxy server to be used for FTP requests."]
    pub fn proxyForFtp(this: &ProxyRules) -> Option<ProxyServer>;
    # [wasm_bindgen (method , getter , js_class = ProxyRules)]
    #[doc = "The proxy server to be used for HTTP requests."]
    pub fn proxyForHttp(this: &ProxyRules) -> Option<ProxyServer>;
    # [wasm_bindgen (method , getter , js_class = ProxyRules)]
    #[doc = "The proxy server to be used for HTTPS requests."]
    pub fn proxyForHttps(this: &ProxyRules) -> Option<ProxyServer>;
    # [wasm_bindgen (method , getter , js_class = ProxyRules)]
