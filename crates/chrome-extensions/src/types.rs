...
#[wasm_bindgen]
extern "C" {
    # [wasm_bindgen (extends = :: js_sys :: JsString , js_name = "ChromeSettingScope" , typescript_type = "ChromeSettingScope")]
    ...
    # [wasm_bindgen (extends = :: js_sys :: Object , js_name = "ChromeSetting" , typescript_type = "ChromeSetting")]
    #[derive(Debug, Clone, PartialEq, Eq)]
